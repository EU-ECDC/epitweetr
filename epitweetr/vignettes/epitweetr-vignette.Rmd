...
-   **twitter_auth**: Twitter authentication either with Twitter account or Twitter app
-   **search**: search task is running
-   **detect_activation**: 
-   **detection**: detection task is running
-   **scheduler**:
-   **tweets**:
-   **os64**:
...
-   **move_from_temp**:
-   **geonames**: Geonames.org database is downloaded
-   **languages**: languages vectors and indexes are downloaded
-   **geotag**: geotag task is running
-   **aggregate**: aggregate task is running
-   **alerts**: alerts task is running
-   **pandoc**: Pandoc is installed
-   **tex**: Tex is installed
