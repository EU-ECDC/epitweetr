...
knitr::include_graphics("img/config.png")
```
<span style="color:red">Francisco can you add a screenshot with the extra 3 buttons? I don't want to do a screenshot of my config page, as I have error messages.</span>
...
In the status section, you can tell when the last process was running for tweet search and detection pipeline and you can click on “activate” if you would like to run the process at that moment.
<span style="color:red">Francisco - is the above statement true?</span>
...
-   In **Data directory** you can view the directory that epitweetr uses to store the tweet and associated data collected. This is also the directory that the dashboard uses to obtain the datasets for displaying the visualisations. You need to change this in the R console. <span style="color:red">Francisco - is this true?</span>

-   The **Search span** relates to how long a search plan is carried out. The  default is 60 minutes. <span style="color:red">Francisco - anything to complete here? I've not really referred to this in the previous text, it was called "schedule span" previously?</span>

-   The **Detect span** relates to how frequently the processes of the detection pipeline (geotagging, aggregation and alert detection) are carried out. The default is 90 minutes.
...
-   **Maven repository:** <span style="color:red">Francisco - what's this?</span>

-   **Winutils URL:** <span style="color:red">Francisco - can you add some text here?</span>

-   **Regions disclaimer:** Different definitions of countries and regions exist. If you would like to add a disclaimer to the map you are using. This disclaimer is added to the image export of the dashboard map, and also the PDF export of the dashboard. <span style="color:red">Francisco - the PDF does not work for me, so I am guessing this is correct</span>
...
<span style="color:red">Francisco, is there anything to say about the checkbox **unsafe certificates**?
...
<span style="color:red">Francisco, I can't really see the "Alerts" tab. Can you send a screenshot? I can then try and write something about it </span>
