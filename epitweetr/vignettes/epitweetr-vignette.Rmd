...
The primary objective of epitweetr is to use Twitter standard search API version 1.1 in order to detect early signals of potential threats or events by topic and by geographical unit.
