...
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/dashboard.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '100%'}
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/alerts.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '100%'}
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/geotag_evaluation.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '100%'}
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/config.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '100%'}
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/troubleshoot.png")
```
...
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/run_geonames.png")
```
...
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/Activate_tweet_search.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '80%'}
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/Detection_pipeline_activate.png")
```
    -   Other platforms: In a new R session run the following command
```{r, eval=FALSE, echo=TRUE}
library(epitweetr)
...
```{r echo=FALSE, fig.cap="", out.width = '50%'}
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/Twitter_authentication_dev_app.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '100%'}
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/topics.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '80%'}
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/Example_topics_list.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '80%'}
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/Schedule_plan_image.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '80%'}
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/Search_plan_queues.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '80%'}
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/config_languages.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '50%'}
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/geolocation_threshold.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '100%'}
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/geolocated.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '100%'}
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/country_counts.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '100%'}
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/topwords.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '100%'}
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/subscribers.png")
```
...
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/search_folder.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '40%'}
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/anthrax.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '50%'}
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/series_folder.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '40%'}
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/topics_countries.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '40%'}
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/period.png")
```
...
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/time_unit.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '30%'}
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/include_retweets.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '30%'}
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/location_type.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '30%'}
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/signal_detection_fpr.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '40%'}
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/outlier_dashboard.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '30%'}
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/Bonferroni_correction.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '30%'}
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/days_in_baseline.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '30%'}
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/same_weekday_baseline.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '100%'}
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/timeline.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '30%'}
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/hover_trendline.png")
```
...
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/map.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '60%'}
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/hover_map.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '50%'}
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/top_words.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '50%'}
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/status.png")
```
...
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/detection_pipeline.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '50%'}
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/signal_detection_config.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '40%'}
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/general.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '30%'}
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/twitter_authentication.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '100%'}
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/languages.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '100%'}
knitr::include_graphics("https://github.com/EU-ECDC/epitweetr/raw/master/epitweetr/vignettes/img/ebola.png")
```
