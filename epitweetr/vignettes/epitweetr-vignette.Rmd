...
-   The alerts page, where you can view the current alerts and train machine learning algorithms for alert classification on user defined categories

-   The geotag evaluation page, where you can evaluate the geolocation algorithm and provide annotations for improve its performance

-   The data protection page, where you can search, anonymise and delete tweets from the epitweetr database to honor data deletion requests from third parties
