...
-   Java 1.8 eg. openjdk version "1.8" [*https://www.java.com/download/*]. The 64-bit rather than the 32-bit version is preferred, due to memory limitations. In Mac, also the Java Development Kit [*https://docs.oracle.com/javase/10/install/installation-jdk-and-jre-macos.htm*]
...
-   **twitter_auth**: Twitter token is created after authenticating either with Twitter account or Twitter developer application
