...
Topics cannot contain spaces (i.e. the column 'Topic' in the topic.xlsx file embedded in epitweetr cannot contain spaces). You can add, for example, underscore to separate a topic with more than one word.
...
### Not seeing data in the dashboard for a topic
This may happen if you have added a new topic that contains two words in the name. Please ensure not to add new topics that have spaces in the name; you can use, for example, underscore to separate the words.
