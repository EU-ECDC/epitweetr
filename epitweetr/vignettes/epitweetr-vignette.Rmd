...
```{r echo=FALSE, fig.cap="", out.width = '100%'}
knitr::include_graphics("img/geotag_evaluation.png")
```
...
knitr::include_graphics("img/run_geonames.png")
```
...
knitr::include_graphics("img/Activate_tweet_search.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '80%'}
knitr::include_graphics("img/Detection_pipeline_activate.png")
```
    -   Other platforms: In a new R session run the following command
```{r, eval=FALSE, echo=TRUE}
library(epitweetr)
...
```{r echo=FALSE, fig.cap="", out.width = '50%'}
knitr::include_graphics("img/Twitter_authentication_dev_app.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '80%'}
knitr::include_graphics("img/Example_topics_list.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '80%'}
knitr::include_graphics("img/Schedule_plan_image.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '80%'}
knitr::include_graphics("img/Search_plan_queues.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '80%'}
knitr::include_graphics("img/config_languages.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '50%'}
knitr::include_graphics("img/geolocation_threshold.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '100%'}
knitr::include_graphics("img/country_counts.png")
```
...
knitr::include_graphics("img/search_folder.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '50%'}
knitr::include_graphics("img/series_folder.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '40%'}
knitr::include_graphics("img/topics_countries.png")
```
...
knitr::include_graphics("img/time_unit.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '30%'}
knitr::include_graphics("img/include_retweets.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '30%'}
knitr::include_graphics("img/location_type.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '30%'}
knitr::include_graphics("img/signal_detection_fpr.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '40%'}
knitr::include_graphics("img/outlier_dashboard.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '30%'}
knitr::include_graphics("img/Bonferroni_correction.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '30%'}
knitr::include_graphics("img/days_in_baseline.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '30%'}
knitr::include_graphics("img/same_weekday_baseline.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '30%'}
knitr::include_graphics("img/hover_trendline.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '60%'}
knitr::include_graphics("img/hover_map.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '50%'}
knitr::include_graphics("img/top_words.png")
```
...
knitr::include_graphics("img/detection_pipeline.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '50%'}
knitr::include_graphics("img/signal_detection_config.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '30%'}
knitr::include_graphics("img/twitter_authentication.png")
```
