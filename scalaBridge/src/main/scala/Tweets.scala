  ...
  def getJsonTweets(path:String)(implicit spark:SparkSession, storage:Storage)= {
      Tweets.getSearchJson(path)
        ...
        .select(
          ...
          , col("tweet.place.bounding_box.coordinates").getItem(0).getItem(0).getItem(0).as("place_country_long1")
          , col("tweet.place.bounding_box.coordinates").getItem(0).getItem(0).getItem(1).as("place_country_lat1")
          , col("tweet.place.bounding_box.coordinates").getItem(0).getItem(1).getItem(0).as("place_country_long2")
          , col("tweet.place.bounding_box.coordinates").getItem(0).getItem(1).getItem(1).as("place_country_lat2")
          , col("tweet.place.bounding_box.coordinates").getItem(0).getItem(2).getItem(0).as("place_country_long3")
          , col("tweet.place.bounding_box.coordinates").getItem(0).getItem(2).getItem(1).as("place_country_lat3")
          , col("tweet.place.bounding_box.coordinates").getItem(0).getItem(3).getItem(0).as("place_country_long4")
          , col("tweet.place.bounding_box.coordinates").getItem(0).getItem(3).getItem(1).as("place_country_lat4")
        ) 
  }
